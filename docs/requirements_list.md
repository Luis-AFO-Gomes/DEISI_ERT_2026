...
| REQ-008 | Qualquer sócio deverá poder adicionar títulos e exemplares à plataforma | F | Sócio<br>administrador | S | L | S |
...
| REQ-015 | A inserção de **TÍTULO** requer a existência de **TIPO**, referente ao formato de publicação | F | Sócio<br>Administrador | C | s | S |
